  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-3xl">
      <div className="flex items-center gap-3">
        <div className="w-6 h-4 rounded-sm bg-surface-2 animate-pulse" />
        ...
        <div className="rounded-sm border border-border bg-surface p-4 space-y-3 animate-pulse">
          ...
          <div className="space-y-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="h-4 w-full rounded-sm bg-surface-2" />
            ))}
          </div>
        </div>
        <div className="rounded-sm border border-border bg-surface p-4 space-y-3 animate-pulse">
          <div className="h-3 w-16 rounded-sm bg-surface-2" />
          <div className="h-20 w-full rounded-sm bg-surface-2" />
        </div>
      </div>
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex items-center gap-3 p-3 rounded-sm border border-border bg-surface animate-pulse">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div className="h-2.5 w-24 rounded-sm bg-surface-2" />
            </div>
          </div>
        ))}
      </div>
