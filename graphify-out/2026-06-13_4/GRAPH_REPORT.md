...
## Corpus Check
- 253 files · ~102,179 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1825 nodes · 2194 edges · 208 communities (159 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d3e607d`
...
Cohesion: 0.09
Nodes (26): AccountCard(), AccountCardProps, container, item, PostDetailPage(), MediaGrid(), MediaGridProps, LogsApp() (+18 more)
...
Cohesion: 0.07
Nodes (32): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+24 more)
...
Cohesion: 0.08
Nodes (19): metadata, CTASection(), FeatureCard(), FeatureCardProps, iconMap, features, FeaturesSection(), AUTH_PATHS (+11 more)
...
Cohesion: 0.16
Nodes (13): AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), ValidationErrors, SchedulePicker() (+5 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (13): TallyDotProps, TimecodeDisplayProps, BadgeProps, Button, ButtonProps, useDashboard(), AccountsApp(), DashboardApp() (+5 more)
...
Cohesion: 0.10
Nodes (13): inter, metadata, RootLayout(), SmoothScroll(), ErrorBoundary, ErrorBoundaryProps, ErrorBoundaryState, Toast (+5 more)
...
Cohesion: 0.27
Nodes (12): call(), DashboardResult, deleteAccount(), getAccounts(), getCalendar(), getDashboard(), getMedia(), getPosts() (+4 more)
...
Cohesion: 0.12
Nodes (20): AuthForm(), AuthFormProps, AuthLayout(), AuthLayoutProps, AuthGate(), ForgotPasswordPage(), Input, InputProps (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.13
Nodes (13): ActivityFeed(), ActivityItem, container, DashboardPage(), item, PublishingVelocity(), PublishingVelocityProps, VelocityDay (+5 more)
...
Cohesion: 0.12
Nodes (15): code:block1 (https://multi-user-social-media-scheduler-s.vercel.app/api/a), code:block2 (http://localhost:3000/api/auth/meta/callback), code:block3 ({FRONTEND_URL}/accounts/connect), Facebook Login, Instagram Basic Display, Meta App Setup Guide, Pages API, Step 1: Create a Facebook App (+7 more)
...
Cohesion: 0.32
Nodes (16): badRequest(), getServerClient(), handleAccounts(), handleCalendar(), handleDashboard(), handleDeleteAccount(), handleDeleteMedia(), handleDeleteUser() (+8 more)
...
Cohesion: 0.20
Nodes (12): useMedia(), callWebhook(), cancelPost(), connectOAuth(), createPost(), CreatePostData, N8nResponse, updatePost() (+4 more)
...
Cohesion: 0.24
Nodes (9): ConnectButton(), ConnectButtonProps, AccountsContent(), AccountsPage(), container, item, oauthErrors, useAccounts() (+1 more)
...
Cohesion: 0.50
Nodes (3): options, PlatformSelector(), PlatformSelectorProps
...
Cohesion: 0.29
Nodes (6): Backend Dependencies, Components (all built), Frontend Progress — Console Social Media Scheduler, Hooks (7/7 complete), Library, Routes (15/15 complete)
...
Cohesion: 0.33
Nodes (5): CalendarGrid(), CalendarGridProps, dayLabels, DayCell(), DayCellProps
...
Cohesion: 0.33
Nodes (3): CheckFilled(), CheckIcon(), LoadingState
...
Cohesion: 0.15
Nodes (8): MediaDropzone(), MediaDropzoneProps, cn(), LeftNav(), LeftNavProps, navItems, TopBar(), TopBarProps
...
## Knowledge Gaps
- **961 isolated node(s):** `scheduleBtn`, `ALLOWED_TYPES`, `ValidationErrors`, `status`, `failedTests` (+956 more)
...
- **Why does `Button` connect `Landing Page UI` to `Community 68`, `Project Dependencies`, `Community 37`, `Instagram Publish Workflow`, `Facebook Publish Workflow`, `Community 15`, `Community 63`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 37` to `Community 162`, `Community 68`, `Project Dependencies`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 20`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 162` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Community 144`, `Community 177`, `Community 18`, `Community 121`, `Community 63`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `scheduleBtn`, `ALLOWED_TYPES`, `ValidationErrors` to the rest of the system?**
