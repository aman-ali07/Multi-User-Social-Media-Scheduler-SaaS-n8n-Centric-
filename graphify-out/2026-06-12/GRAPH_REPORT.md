# Graph Report - saas  (2026-06-10)

## Corpus Check
- 249 files · ~103,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1722 nodes · 2055 edges · 189 communities (147 shown, 42 thin omitted)
...
9. `N8N Social Scheduler SaaS` - 14 edges
10. `AuthGuard()` - 13 edges
...
Cohesion: 0.15
Nodes (15): ActivityTimeline(), ActivityTimelineProps, container, item, LogsPage(), PostRowProps, OAuthState, Platform (+7 more)
...
Cohesion: 0.09
Nodes (25): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+17 more)
...
Cohesion: 0.09
Nodes (12): TallyDotProps, TimecodeDisplayProps, VUMeterProps, BadgeProps, useDashboard(), DashboardApp(), LogsApp(), PostsApp() (+4 more)
...
Cohesion: 0.24
Nodes (9): CalendarPost, callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost(), WebhookOptions, supabase (+1 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (33): bilderberg, jetbrainsMono, metadata, RootLayout(), satoshi, CalendarGrid(), CalendarGridProps, CalendarPost (+25 more)
...
Cohesion: 0.18
Nodes (12): AuthGate(), Button, ButtonProps, Input, InputProps, useAuth(), useSettings(), CalendarApp() (+4 more)
...
Cohesion: 0.09
Nodes (22): buildContainerUrl, buildPublishUrl, callRetry, checkAlreadyPublished, checkContainerStatus, checkPublishResult, createContainer, hasExistingContainer (+14 more)
...
Cohesion: 0.12
Nodes (16): buildFbPayload, callFbApi, callRetry, checkAlreadyPublished, checkResult, isAlreadyPublished, logFailure, logSuccess (+8 more)
...
Cohesion: 0.13
Nodes (15): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+7 more)
...
Cohesion: 0.40
Nodes (12): badRequest(), getServerClient(), handleAccounts(), handleCalendar(), handleDashboard(), handleMedia(), handlePosts(), handleSettings() (+4 more)
...
Cohesion: 0.10
Nodes (14): ActivityItem, UpcomingPost, VelocityDay, call(), DashboardResult, getAccounts(), getCalendar(), getDashboard() (+6 more)

### Community 64 - "Community 64"
Cohesion: 0.24
Nodes (9): useMedia(), MediaGrid(), MediaGridProps, container, item, MediaPage(), MediaApp(), MediaAsset (+1 more)
...
## Knowledge Gaps
- **926 isolated node(s):** `name`, `version`, `description`, `main`, `doc` (+921 more)
...
- **Why does `useAuth()` connect `Community 20` to `Community 64`, `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 51`, `Community 25`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Community 17`, `Community 25`, `Landing Page UI`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Button` connect `Landing Page UI` to `Community 64`, `Project Dependencies`, `Community 37`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 20`, `Community 25`?**
