...
## Corpus Check
- 161 files · ~70,340 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1289 nodes · 1501 edges · 133 communities (97 shown, 36 thin omitted)
...
4. `supabase` - 15 edges
5. `cn()` - 15 edges
6. `N8N Social Scheduler SaaS` - 14 edges
7. `AuthGuard()` - 13 edges
8. `File Map` - 13 edges
9. `ConsoleShell()` - 12 edges
10. `Phase 6 — Next.js Frontend Plan` - 12 edges
...
Cohesion: 0.06
Nodes (28): AccountCard(), AccountCardProps, AccountSelector(), AccountSelectorProps, ActivityItem, UpcomingPost, VelocityDay, ActivityTimeline() (+20 more)
...
Cohesion: 0.19
Nodes (8): container, item, themes, ConsoleShell(), ConsoleShellProps, StatusBar(), TopBar(), TopBarProps
...
Cohesion: 0.17
Nodes (11): ConnectButtonProps, CalendarPage(), container, item, monthNames, CalendarPost, useCalendar(), Button (+3 more)
...
Cohesion: 0.22
Nodes (10): container, item, PostDetailPage(), callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost() (+2 more)
...
Cohesion: 0.16
Nodes (12): ConnectButton(), AccountsPage(), container, item, useAccounts(), useMedia(), container, item (+4 more)
...
Cohesion: 0.17
Nodes (13): AuthForm(), AuthFormProps, AuthGuard(), AuthLayout(), AuthLayoutProps, MotionNarrative(), useAuth(), LoginForm() (+5 more)
...
## Knowledge Gaps
- **733 isolated node(s):** `Motive`, `code:block1 (Frontend (Next.js 16) ──→ n8n (backend) ──→ Supabase DB + St)`, `Database (9 tables)`, `n8n Workflow Map (11 workflows)`, `Frontend (14 routes)` (+728 more)
...
- **Why does `useAuth()` connect `Community 37` to `Project Dependencies`, `Community 38`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 51`, `Community 20`, `Community 25`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Project Dependencies`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `supabase` connect `Community 17` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `Motive`, `code:block1 (Frontend (Next.js 16) ──→ n8n (backend) ──→ Supabase DB + St)`, `Database (9 tables)` to the rest of the system?**
