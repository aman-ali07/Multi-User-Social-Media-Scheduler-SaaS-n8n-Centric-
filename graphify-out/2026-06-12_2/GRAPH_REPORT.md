...
## Corpus Check
- 255 files · ~104,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1743 nodes · 2081 edges · 195 communities (152 shown, 43 thin omitted)
...
3. `supabase` - 20 edges
4. `../../layouts/ConsoleLayout.astro` - 19 edges
5. `Console — Multi-User Social Media Scheduler` - 19 edges
6. `Button` - 18 edges
7. `cn()` - 17 edges
...
Cohesion: 0.07
Nodes (25): AccountCard(), AccountCardProps, AccountSelector(), AccountSelectorProps, BadgeProps, ActivityTimeline(), ActivityTimelineProps, MediaGrid() (+17 more)
...
Cohesion: 0.11
Nodes (20): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+12 more)
...
Cohesion: 0.13
Nodes (15): CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), container, item, ValidationErrors, options (+7 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (13): TimecodeDisplayProps, BadgeProps, useDashboard(), supabase, container, item, LogsPage(), DashboardApp() (+5 more)
...
Cohesion: 0.47
Nodes (6): callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost(), WebhookOptions

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (27): bilderberg, jetbrainsMono, metadata, RootLayout(), satoshi, CalendarGrid(), CalendarGridProps, CalendarPost (+19 more)
...
Cohesion: 0.15
Nodes (11): TallyDotProps, Button, ButtonProps, Input, InputProps, useSettings(), ComposerApp(), SettingsApp() (+3 more)
...
Cohesion: 0.15
Nodes (7): ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors, SkeletonCard()
...
Cohesion: 0.07
Nodes (18): ../../layouts/ConsoleLayout.astro, ../components/pages/AccountsApp, ../../components/pages/AppearanceApp, ../components/pages/CalendarApp, ../components/pages/ComposerApp, ../components/pages/DashboardApp, ../components/pages/LoginForm, ../components/pages/LogsApp (+10 more)
...
Cohesion: 0.09
Nodes (19): ActivityFeed(), ActivityFeedProps, ActivityItem, container, DashboardPage(), item, PublishingVelocity(), PublishingVelocityProps (+11 more)
...
Cohesion: 0.17
Nodes (13): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+5 more)
...
Cohesion: 0.16
Nodes (14): CalendarPost, ActivityItem, UpcomingPost, VelocityDay, call(), DashboardResult, getAccounts(), getCalendar() (+6 more)

### Community 64 - "Community 64"
Cohesion: 0.14
Nodes (9): useMedia(), container, item, MediaPage(), CalendarApp(), CalendarPost, MediaApp(), SkeletonGrid() (+1 more)
...
Cohesion: 0.25
Nodes (9): AuthGate(), useAccounts(), useAuth(), AccountsApp(), LoginForm(), ConsoleShellProps, StatusBar(), TopBar() (+1 more)

### Community 149 - "Community 149"
Cohesion: 0.25
Nodes (5): Toast, ToastContext, ToastContextType, ToastVariant, variantStyles
...
## Knowledge Gaps
- **936 isolated node(s):** `command`, `args`, `name`, `version`, `description` (+931 more)
...
- **Why does `useAuth()` connect `Community 148` to `Community 64`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 51`, `Community 20`, `Community 63`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Project Dependencies`, `Landing Page UI`, `Community 17`, `Community 51`, `Community 148`, `Community 25`?**
