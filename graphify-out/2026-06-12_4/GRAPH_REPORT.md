...
## Corpus Check
- 214 files · ~83,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1672 nodes · 1992 edges · 189 communities (143 shown, 46 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4337c331`
...
## Communities (189 total, 46 thin omitted)
...
Cohesion: 0.08
Nodes (23): AccountCard(), ActivityTimelineProps, MediaGrid(), MediaGridProps, PostRow(), PostRowProps, AccountStatus, DashboardStats (+15 more)
...
Cohesion: 0.07
Nodes (33): ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors, container, item (+25 more)
...
Cohesion: 0.08
Nodes (29): AccountCardProps, AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), container (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (14): TallyDotProps, TimecodeDisplayProps, BadgeProps, Button, ButtonProps, useAccounts(), AccountsApp(), CalendarApp() (+6 more)
...
Cohesion: 0.33
Nodes (5): Input, InputProps, useSettings(), SettingsApp(), SettingsPage()
...
Cohesion: 0.16
Nodes (20): AuthGate(), useAuth(), CalendarPost, useDashboard(), useMedia(), call(), DashboardResult, getAccounts() (+12 more)
...
## Knowledge Gaps
- **887 isolated node(s):** `aider chat started at 2026-05-26 23:52:59`, `command`, `args`, `$schema`, `plugin` (+882 more)
...
- **Why does `useAuth()` connect `Community 63` to `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 51`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Button` connect `Landing Page UI` to `Project Dependencies`, `Community 37`, `Facebook Publish Workflow`, `Community 15`, `Community 20`, `Community 63`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `aider chat started at 2026-05-26 23:52:59`, `command`, `args` to the rest of the system?**
