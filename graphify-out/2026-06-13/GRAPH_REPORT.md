...
## Corpus Check
- 216 files · ~92,228 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1746 nodes · 2061 edges · 194 communities (149 shown, 45 thin omitted)
...
Cohesion: 0.12
Nodes (22): AccountCard(), container, item, PostDetailPage(), ActivityTimelineProps, PostRow(), PostRowProps, AccountStatus (+14 more)
...
Cohesion: 0.07
Nodes (31): ConnectButton(), ConnectButtonProps, container, item, oauthErrors, container, item, themes (+23 more)
...
Cohesion: 0.09
Nodes (17): metadata, FeatureCard(), FeatureCardProps, features, FeaturesSection(), AUTH_PATHS, FloatingSignIn(), Footer() (+9 more)
...
Cohesion: 0.08
Nodes (21): AccountsPage(), AuthGate(), TimecodeDisplayProps, TransportControlsProps, VUMeterProps, BadgeProps, useAccounts(), useAuth() (+13 more)
...
Cohesion: 0.14
Nodes (9): bilderberg, inter, jetbrainsMono, metadata, RootLayout(), satoshi, ErrorBoundary, ErrorBoundaryProps (+1 more)
...
Cohesion: 0.12
Nodes (14): TallyDotProps, Button, ButtonProps, Input, InputProps, useSettings(), CalendarApp(), CalendarPost (+6 more)
...
Cohesion: 0.25
Nodes (9): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+1 more)
...
Cohesion: 0.18
Nodes (17): CalendarPost, callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost(), call(), DashboardResult (+9 more)
...
Cohesion: 0.24
Nodes (8): MediaDropzone(), MediaDropzoneProps, cn(), containerVariants, itemVariants, LeftNav(), LeftNavProps, navItems
...
## Knowledge Gaps
- **948 isolated node(s):** `command`, `args`, `name`, `version`, `description` (+943 more)
...
- **Why does `useAuth()` connect `Community 15` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 51`, `Community 20`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 68` to `Project Dependencies`, `Landing Page UI`, `Community 18`, `Community 149`, `Community 151`, `Community 121`, `Community 63`?**
