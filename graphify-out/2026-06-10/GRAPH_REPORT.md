# Graph Report - saas  (2026-06-09)

## Corpus Check
- 239 files · ~87,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1619 nodes · 1917 edges · 182 communities (140 shown, 42 thin omitted)
...
Cohesion: 0.11
Nodes (25): AccountCard(), BadgeProps, ActivityTimeline(), ActivityTimelineProps, container, item, LogsPage(), MediaGrid() (+17 more)
...
Cohesion: 0.10
Nodes (23): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+15 more)
...
Cohesion: 0.10
Nodes (11): TallyDotProps, Button, ButtonProps, useMedia(), CalendarApp(), CalendarPost, MediaApp(), PostsApp() (+3 more)
...
Cohesion: 0.21
Nodes (10): Input, InputProps, useSettings(), SettingsApp(), container, item, SettingsPage(), Profile (+2 more)
...
Cohesion: 0.11
Nodes (11): ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors, BadgeProps, useAccounts() (+3 more)
...
Cohesion: 0.14
Nodes (12): AuthGate(), TimecodeDisplayProps, useAuth(), ActivityItem, UpcomingPost, useDashboard(), VelocityDay, ComposerApp() (+4 more)
...
## Knowledge Gaps
- **880 isolated node(s):** `name`, `version`, `description`, `main`, `doc` (+875 more)
...
- **Why does `useAuth()` connect `Community 36` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 51`, `Community 20`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 20` to `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 17`, `Community 51`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Project Dependencies`, `Community 36`, `Landing Page UI`, `Community 17`, `Community 25`?**
