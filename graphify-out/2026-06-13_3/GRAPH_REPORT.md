...
## Corpus Check
- 252 files · ~101,934 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1823 nodes · 2189 edges · 209 communities (160 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `874e5789`
...
Cohesion: 0.13
Nodes (20): usePosts(), container, item, PostsContent(), PostsPage(), PostRow(), PostRowProps, AccountStatus (+12 more)
...
Cohesion: 0.09
Nodes (23): ConnectButton(), ConnectButtonProps, AccountsContent(), AccountsPage(), container, item, oauthErrors, container (+15 more)
...
Cohesion: 0.14
Nodes (15): AccountCard(), AccountCardProps, AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage() (+7 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (9): TallyDotProps, Button, ButtonProps, CalendarApp(), CalendarPost, LogsApp(), PostLog, SkeletonGrid() (+1 more)
...
Cohesion: 0.24
Nodes (13): call(), DashboardResult, deleteAccount(), getAccounts(), getCalendar(), getDashboard(), getMedia(), getPosts() (+5 more)
...
Cohesion: 0.09
Nodes (26): AuthForm(), AuthFormProps, AuthLayout(), AuthLayoutProps, AuthGate(), ForgotPasswordPage(), Input, InputProps (+18 more)

### Community 38 - "Community 38"
Cohesion: 0.10
Nodes (16): TimecodeDisplayProps, ActivityFeed(), ActivityItem, container, DashboardPage(), item, StatProps, StatsRow() (+8 more)
...
Cohesion: 0.19
Nodes (13): container, item, callWebhook(), cancelPost(), connectOAuth(), createPost(), CreatePostData, N8nResponse (+5 more)
...
Cohesion: 0.24
Nodes (8): useMedia(), MediaGrid(), MediaGridProps, container, item, MediaPage(), MediaApp(), MediaAsset
...
Cohesion: 0.09
Nodes (15): MediaDropzone(), MediaDropzoneProps, cn(), PageTransition(), ConsoleShellProps, LeftNav(), LeftNavProps, navItems (+7 more)
...
## Knowledge Gaps
- **961 isolated node(s):** `Overview`, `Brand & Accent`, `Surface`, `Text`, `Semantic` (+956 more)
...
- **Why does `useAuth()` connect `Community 37` to `Community 162`, `Community 68`, `Project Dependencies`, `Community 38`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 20`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 37` to `Project Dependencies`, `Community 68`, `Landing Page UI`, `Instagram Publish Workflow`, `Facebook Publish Workflow`, `Community 15`, `Community 63`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 162` to `Project Dependencies`, `Community 37`, `Community 38`, `Community 177`, `Community 18`, `Community 121`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `Overview`, `Brand & Accent`, `Surface` to the rest of the system?**
