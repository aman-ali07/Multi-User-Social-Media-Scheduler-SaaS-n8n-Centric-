...
## Corpus Check
- 246 files · ~101,643 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1684 nodes · 1980 edges · 193 communities (150 shown, 43 thin omitted)
...
Cohesion: 0.12
Nodes (14): ActivityItem, UpcomingPost, VelocityDay, MediaGrid(), MediaGridProps, DashboardStats, MediaAsset, OAuthState (+6 more)
...
Cohesion: 0.08
Nodes (28): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+20 more)
...
Cohesion: 0.11
Nodes (19): AccountCardProps, AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), container (+11 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (22): AuthGate(), TallyDotProps, TimecodeDisplayProps, BadgeProps, Button, ButtonProps, useAccounts(), useAuth() (+14 more)
...
Cohesion: 0.29
Nodes (6): Input, InputProps, useSettings(), SettingsApp(), SettingsPage(), Input
...
Cohesion: 0.14
Nodes (8): AccountCard(), ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors, SkeletonCard()
...
Cohesion: 0.19
Nodes (12): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+4 more)
...
Cohesion: 0.31
Nodes (7): ActivityTimeline(), ActivityTimelineProps, container, item, LogsPage(), PostLog, Badge()
...
## Knowledge Gaps
- **913 isolated node(s):** `name`, `version`, `description`, `main`, `doc` (+908 more)
...
- **Why does `useAuth()` connect `Community 15` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 17`, `Community 51`, `Community 20`, `Community 150`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 147` to `Landing Page UI`, `Community 17`, `Community 18`, `Community 148`, `Community 149`, `Community 150`, `Community 151`, `Community 25`?**
