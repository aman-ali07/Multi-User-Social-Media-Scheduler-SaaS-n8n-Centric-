...
## Corpus Check
- 153 files · ~50,932 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1160 nodes · 1364 edges · 125 communities (89 shown, 36 thin omitted)
...
Cohesion: 0.14
Nodes (15): AccountsPage(), container, item, container, item, themes, AuthGuard(), useAccounts() (+7 more)
...
Cohesion: 0.26
Nodes (10): container, item, PostDetailPage(), callWebhook(), cancelPost(), connectOAuth(), createPost(), registerMedia() (+2 more)
...
Cohesion: 0.22
Nodes (8): CalendarPage(), container, item, monthNames, useCalendar(), SkeletonCard(), SkeletonGrid(), SkeletonList()
...
Cohesion: 0.19
Nodes (10): ConnectButton(), ConnectButtonProps, useMedia(), container, item, MediaPage(), Button, ButtonProps (+2 more)

### Community 78 - "Community 78"
Cohesion: 0.21
Nodes (10): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsPage(), PostRow() (+2 more)
...
## Knowledge Gaps
- **654 isolated node(s):** `Prerequisites`, `1. Provision Oracle Instance`, `code:bash (ssh ubuntu@your-oracle-ip)`, `code:bash (git clone <your-repo-url> ~/saas)`, `code:yaml (services:)` (+649 more)
...
- **Why does `useAuth()` connect `Community 63` to `Auth & Accounts UI`, `Post & Calendar Components`, `Dashboard Activity Feed`, `Community 64`, `Post Composer UI`, `Auth Pages & Forms`, `Community 75`, `Community 78`, `Community 61`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `cn()` connect `Root Layout & Calendar Grid` to `Community 64`, `Post & Calendar Components`, `Post Composer UI`, `Community 75`, `Community 63`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Supabase Postgres Best Practices` connect `Postgres Best Practices` to `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `Prerequisites`, `1. Provision Oracle Instance`, `code:bash (ssh ubuntu@your-oracle-ip)` to the rest of the system?**
