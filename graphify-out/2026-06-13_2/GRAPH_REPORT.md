# Graph Report - saas  (2026-06-13)

## Corpus Check
- 233 files · ~96,278 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1822 nodes · 2168 edges · 210 communities (164 shown, 46 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f64c47b1`
...
4. `supabase` - 20 edges
5. `cn()` - 19 edges
6. `Console — Multi-User Social Media Scheduler` - 19 edges
7. `../../layouts/ConsoleLayout.astro` - 19 edges
8. `compilerOptions` - 16 edges
9. `POST()` - 15 edges
10. `AuthGuard()` - 14 edges
...
## Communities (210 total, 46 thin omitted)
...
Cohesion: 0.12
Nodes (19): ActivityTimelineProps, MediaGrid(), MediaGridProps, PostRowProps, AccountStatus, LogStatus, MediaAsset, OAuthState (+11 more)

### Community 5 - "Social Media API Integration"
Cohesion: 0.10
Nodes (22): media_assets, oauth_state, post_logs, scheduled_posts, social_accounts, workflow_runs, n8n Workflows Implementation Plan, cancel_posts_on_account_delete() (+14 more)
...
Cohesion: 0.06
Nodes (40): AccountCard(), ConnectButton(), ConnectButtonProps, container, item, oauthErrors, container, item (+32 more)
...
Cohesion: 0.05
Nodes (39): dependencies, class-variance-authority, clsx, framer-motion, gsap, @gsap/react, lenis, lucide-react (+31 more)
...
Cohesion: 0.08
Nodes (21): metadata, CTASection(), FeatureCard(), FeatureCardProps, iconMap, features, FeaturesSection(), AUTH_PATHS (+13 more)
...
Cohesion: 0.10
Nodes (21): AccountCardProps, AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, MediaDropzone(), MediaDropzoneProps, ALLOWED_TYPES (+13 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (13): AccountsPage(), TallyDotProps, BadgeProps, Button, ButtonProps, useAccounts(), AccountsApp(), CalendarApp() (+5 more)
...
Cohesion: 0.16
Nodes (16): Input, InputProps, useSettings(), call(), getAccounts(), getCalendar(), getDashboard(), getMedia() (+8 more)
...
Cohesion: 0.29
Nodes (6): How to Get Your Meta API Credentials (Line-by-Line Guide), Part 1: Creating the Meta App, Part 2: Gathering Your App ID and Secret, Part 3: Adding Facebook Login for Business, Part 4: Requesting the Right Permissions (Scopes), Part 5: Connecting Instagram to Facebook
...
Cohesion: 0.10
Nodes (20): callRetry, checkAlreadyPublished, checkContainerStatus, checkCreateError, checkPublishError, checkStatusError, createContainer, formatExistingContainer (+12 more)
...
Cohesion: 0.29
Nodes (6): 1. Creating Your Account, 2. Connecting Your Social Accounts, 3. Uploading Your Media, 4. Scheduling Your First Post, 5. Tracking Your Posts, Welcome to Console: Your User Guide
...
Cohesion: 0.15
Nodes (11): TimecodeDisplayProps, container, DashboardPage(), item, UpcomingList(), UpcomingListProps, UpcomingPost, useDashboard() (+3 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (18): buildFbPayload, callFbApi, callPayloadRetry, callRetry, checkAlreadyPublished, checkPayloadError, checkResult, isAlreadyPublished (+10 more)
...
Cohesion: 0.50
Nodes (3): FilterBar(), FilterBarProps, statusTabs
...
Cohesion: 0.40
Nodes (4): Console: Your Personal Social Media Engine, 🚀 How to Get Started, Tech Stack, Why is this different?
...
Cohesion: 0.22
Nodes (8): callFailureHandler, checkPost, checkRetries, computeBackoff, incrementAndReschedule, respond, verifyInternalToken, webhookTrigger
...
Cohesion: 0.13
Nodes (24): AuthGate(), CalendarPage(), useAuth(), CalendarPost, useCalendar(), useMedia(), PostDetailPage(), callWebhook() (+16 more)
...
Cohesion: 0.40
Nodes (4): containerVariants, itemVariants, LeftNavProps, navItems
...
Cohesion: 0.25
Nodes (6): Toast, ToastContext, ToastContextType, ToastProvider(), ToastVariant, variantStyles
...
Cohesion: 0.50
Nodes (3): buildCommand, framework, headers
...
Cohesion: 0.16
Nodes (3): getLastPublishDate(), getScheduledQueueCount(), StatusBar()
...
Cohesion: 0.25
Nodes (7): bilderberg, inter, jetbrainsMono, metadata, RootLayout(), satoshi, SmoothScroll()

### Community 161 - "Community 161"
Cohesion: 0.22
Nodes (7): barColors, item, StatCardProps, StatColor, StatProps, StatsRow(), StatsRowProps

### Community 162 - "Community 162"
Cohesion: 0.38
Nodes (4): cn(), CheckFilled(), CheckIcon(), LoadingState
...
## Knowledge Gaps
- **979 isolated node(s):** `command`, `args`, `name`, `version`, `description` (+974 more)
...
- **Why does `useAuth()` connect `Community 63` to `Community 68`, `Community 37`, `Community 38`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 148`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 162` to `Community 160`, `Project Dependencies`, `Community 68`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 149`, `Community 121`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Button` connect `Landing Page UI` to `Project Dependencies`, `Community 37`, `Instagram Publish Workflow`, `Facebook Publish Workflow`, `Community 15`, `Community 20`, `Community 63`?**
