...
## Corpus Check
- 253 files · ~102,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1825 nodes · 2194 edges · 209 communities (160 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb62df75`
...
Cohesion: 0.09
Nodes (32): container, item, usePosts(), PostDetailPage(), callWebhook(), cancelPost(), connectOAuth(), createPost() (+24 more)
...
Cohesion: 0.09
Nodes (20): AccountCard(), AccountCardProps, ConnectButton(), ConnectButtonProps, AccountsContent(), AccountsPage(), container, item (+12 more)
...
Cohesion: 0.13
Nodes (16): AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), ValidationErrors, options (+8 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (23): AuthGate(), TallyDotProps, TimecodeDisplayProps, BadgeProps, Button, ButtonProps, useAccounts(), useAuth() (+15 more)
...
Cohesion: 0.16
Nodes (10): inter, metadata, RootLayout(), SmoothScroll(), Toast, ToastContext, ToastContextType, ToastProvider() (+2 more)
...
Cohesion: 0.09
Nodes (22): AuthForm(), AuthFormProps, AuthLayout(), AuthLayoutProps, ForgotPasswordPage(), Input, InputProps, useSettings() (+14 more)
...
Cohesion: 0.19
Nodes (7): MediaDropzone(), MediaDropzoneProps, cn(), CinematicHeroProps, CheckFilled(), CheckIcon(), LoadingState
...
Cohesion: 0.24
Nodes (7): PageTransition(), ConsoleShellProps, LeftNav(), LeftNavProps, navItems, TopBar(), TopBarProps
...
## Knowledge Gaps
- **961 isolated node(s):** `container`, `item`, `oauthErrors`, `container`, `item` (+956 more)
...
- **Why does `Button` connect `Community 37` to `Project Dependencies`, `Landing Page UI`, `Instagram Publish Workflow`, `Facebook Publish Workflow`, `Community 15`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 15` to `Community 162`, `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 148`, `Community 20`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 144` to `Community 162`, `Project Dependencies`, `Community 37`, `Community 165`, `Landing Page UI`, `Community 15`, `Community 18`, `Community 121`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **What connects `container`, `item`, `oauthErrors` to the rest of the system?**
