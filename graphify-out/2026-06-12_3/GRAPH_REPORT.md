# Graph Report - saas  (2026-06-12)

## Corpus Check
- 212 files · ~82,547 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1745 nodes · 2082 edges · 199 communities (155 shown, 44 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9b460f6`
...
3. `supabase` - 20 edges
4. `Console — Multi-User Social Media Scheduler` - 19 edges
5. `../../layouts/ConsoleLayout.astro` - 19 edges
6. `Button` - 18 edges
7. `cn()` - 17 edges
...
Cohesion: 0.12
Nodes (19): ActivityTimeline(), ActivityTimelineProps, container, item, LogsPage(), MediaGrid(), MediaGridProps, PostRow() (+11 more)
...
Cohesion: 0.09
Nodes (27): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+19 more)
...
Cohesion: 0.06
Nodes (31): dependencies, class-variance-authority, clsx, framer-motion, next, react, react-dom, @sentry/nextjs (+23 more)
...
Cohesion: 0.09
Nodes (18): metadata, FeatureCard(), FeatureCardProps, features, FeaturesSection(), AUTH_PATHS, FloatingSignIn(), Footer() (+10 more)
...
Cohesion: 0.12
Nodes (18): AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), container, item (+10 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (9): TallyDotProps, TransportControlsProps, BadgeProps, LogsApp(), PostsApp(), PostStatus, classMap, SkeletonList() (+1 more)

### Community 16 - "Community 16"
Cohesion: 0.22
Nodes (8): L1: Add `user_id` column to `post_logs` UNIQUE constraint, L2: Add `page_id` to `08-token-refresh.ts` webhook input (future), L3: Remove `newCredential` usage pattern (cosmetic), L4: Fix `02-oauth-callback.ts` redundant `exchangeLongLived` node, L5: Add request timeout to HTTP Request nodes, L6: `encrypt_token`/`decrypt_token` naming, L7: Add `cleanup_old_logs` cron job, Launch Todo — Low Priority Items

### Community 17 - "Community 17"
Cohesion: 0.22
Nodes (9): MediaDropzone(), MediaDropzoneProps, Badge(), cn(), containerVariants, itemVariants, LeftNav(), LeftNavProps (+1 more)
...
Cohesion: 0.15
Nodes (17): AuthGate(), Button, ButtonProps, Input, InputProps, useAuth(), useMedia(), useSettings() (+9 more)
...
Cohesion: 0.12
Nodes (12): AccountCard(), AccountCardProps, ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors (+4 more)
...
Cohesion: 0.06
Nodes (35): API, Approach: 6 Vertical Slices, Architecture Summary, Business Layer, code:block1 (Slice 1: Auth & Accounts      OAuth end-to-end + accounts ma), code:block2 (User ──→ Vercel (Next.js 16) ──→ n8n Cloud (webhooks) ──→ Su), code:block3 ([User clicks "Connect Facebook"]), code:block4 ([Cron runs every 5min]) (+27 more)
...
Cohesion: 0.07
Nodes (19): ../../layouts/ConsoleLayout.astro, ../components/pages/AccountsApp, ../../components/pages/AppearanceApp, ../components/pages/CalendarApp, ../components/pages/ComposerApp, ../components/pages/DashboardApp, ../components/pages/LoginForm, ../components/pages/LogsApp (+11 more)
...
Cohesion: 0.07
Nodes (26): buildContainerUrl, buildPublishUrl, callRetry, checkAlreadyPublished, checkContainerStatus, checkCreateError, checkPublishError, checkPublishResult (+18 more)
...
Cohesion: 0.04
Nodes (46): Architecture, Auth Model, code:block1 (┌───────────────────────────────────────────────────────────), code:bash (docker compose up -d   # n8n + nginx + certbot), code:bash (graphify update .), code:bash (graphify query "How does OAuth work?"), code:block2 (saas/), code:block3 (profiles) (+38 more)
...
Cohesion: 0.11
Nodes (13): TimecodeDisplayProps, ActivityFeed(), ActivityFeedProps, ActivityItem, container, DashboardPage(), item, ActivityItem (+5 more)

### Community 39 - "Community 39"
Cohesion: 0.10
Nodes (20): buildFbPayload, callFbApi, callPayloadRetry, callRetry, checkAlreadyPublished, checkPayloadError, checkResult, isAlreadyPublished (+12 more)

### Community 40 - "Community 40"
Cohesion: 0.10
Nodes (19): dependencies, astro, @astrojs/react, @astrojs/sitemap, framer-motion, react, react-dom, @supabase/supabase-js (+11 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (16): Animation Reference, Broadcast Theme (broadcast.css ~1000 lines), code:block1 (frontend-astro/), Color Palette, Core Architecture, Design Reference, Enhancement History, Features Log (+8 more)
...
Cohesion: 0.12
Nodes (15): code:block1 (https://multi-user-social-media-scheduler-s.vercel.app/accou), code:block2 (http://localhost:3000/accounts/connect), code:block3 ({FRONTEND_URL}/accounts/connect), Facebook Login, Instagram Basic Display, Meta App Setup Guide, Pages API, Step 1: Create a Facebook App (+7 more)

### Community 46 - "Community 46"
Cohesion: 0.12
Nodes (15): code:sql (SELECT table_name FROM information_schema.tables WHERE table), code:sql (SELECT key, value FROM app_config WHERE key = 'encryption_ke), code:sql (SELECT proname FROM pg_proc WHERE proname IN ('encrypt_token), code:bash (openssl rand -hex 32), code:bash (node -e "), code:bash (node -e "), code:tsx (// At top of AccountsPage function:), code:bash (cd frontend && npm run dev) (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (13): compilerOptions, baseUrl, jsx, jsxImportSource, paths, exclude, extends, include (+5 more)

### Community 48 - "Community 48"
Cohesion: 0.17
Nodes (11): 1. Sign In, 2. Connect a Social Account, 3. Create a Post, 4. Schedule Posts, 5. View Published Posts, 6. Cancel a Scheduled Post, Account Limits, Getting Started (+3 more)
...
Cohesion: 0.33
Nodes (3): __dirname, extensions, frontendSrc

### Community 51 - "Community 51"
Cohesion: 0.13
Nodes (14): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+6 more)
...
Cohesion: 0.22
Nodes (10): Architecture, code:bash (cd frontend), code:bash (npm install && cd frontend && npm install && cd ..), code:block3 (saas/), Console — Multi-User Social Media Scheduler, Multi-User Social Media Scheduler, Project Structure, Quick Start (+2 more)
...
Cohesion: 0.35
Nodes (15): badRequest(), getServerClient(), handleAccounts(), handleCalendar(), handleDashboard(), handleDeleteAccount(), handleDeleteMedia(), handleLogs() (+7 more)

### Community 60 - "Community 60"
Cohesion: 0.20
Nodes (9): callFailureHandler, checkPost, checkRetries, computeBackoff, incrementAndReschedule, reschedulePost, respond, verifyInternalToken (+1 more)

### Community 62 - "Community 62"
Cohesion: 0.20
Nodes (9): 1. Better Uptime (betteruptime.com) — Free tier, 2. Sentry (sentry.io) — Free tier, 3. n8n Workflow Monitoring, 4. Custom Status Page (optional), Alert Thresholds, Checklist, Recommended Services, Uptime Monitoring Recommendations (+1 more)

### Community 63 - "Community 63"
Cohesion: 0.18
Nodes (17): CalendarPost, callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost(), WebhookOptions, call() (+9 more)

### Community 64 - "Community 64"
Cohesion: 0.20
Nodes (3): Input, InputProps, InputProps
...
Cohesion: 0.40
Nodes (4): mcpServers, next-devtools, args, command
...
Cohesion: 0.57
Nodes (6): BadgeProps, AccountStatus, LogStatus, PostStatus, BadgeProps, variantStyles
...
Cohesion: 0.50
Nodes (3): UpcomingList(), UpcomingListProps, UpcomingPost
...
## Knowledge Gaps
- **937 isolated node(s):** `command`, `args`, `name`, `version`, `description` (+932 more)
...
- **Why does `useAuth()` connect `Community 20` to `Project Dependencies`, `Community 37`, `Community 38`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 51`, `Community 25`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 17` to `Community 160`, `Community 64`, `Landing Page UI`, `Community 18`, `Community 148`, `Community 20`, `Community 25`, `Community 63`?**
