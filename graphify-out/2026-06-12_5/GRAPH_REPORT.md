...
## Corpus Check
- 214 files · ~83,853 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1673 nodes · 1993 edges · 194 communities (147 shown, 47 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e2d4b37`
...
3. `Console — Multi-User Social Media Scheduler` - 19 edges
4. `supabase` - 19 edges
...
Cohesion: 0.11
Nodes (23): AccountCard(), AccountCardProps, container, item, PostDetailPage(), ActivityTimelineProps, LogsApp(), PostRowProps (+15 more)

### Community 5 - "Social Media API Integration"
Cohesion: 0.09
Nodes (27): app_config, media_assets, oauth_state, post_logs, scheduled_posts, social_accounts, workflow_runs, n8n Workflows Implementation Plan (+19 more)
...
Cohesion: 0.12
Nodes (16): container, item, themes, AuthGuard(), CalendarPage(), container, item, monthNames (+8 more)
...
Cohesion: 0.06
Nodes (32): dependencies, class-variance-authority, clsx, framer-motion, next, react, react-dom, @sentry/nextjs (+24 more)
...
Cohesion: 0.14
Nodes (15): AccountSelector(), AccountSelectorProps, CaptionEditor(), CaptionEditorProps, ALLOWED_TYPES, ComposerPage(), container, item (+7 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (6): TimecodeDisplayProps, BadgeProps, PostsApp(), PostStatus, classMap, SkeletonProps
...
Cohesion: 0.06
Nodes (26): bilderberg, jetbrainsMono, metadata, RootLayout(), satoshi, CalendarGrid(), CalendarGridProps, CalendarPost (+18 more)
...
Cohesion: 0.24
Nodes (8): Input, InputProps, useSettings(), SettingsApp(), container, item, SettingsPage(), Input
...
Cohesion: 0.09
Nodes (18): ActivityFeed(), ActivityFeedProps, ActivityItem, container, DashboardPage(), item, PublishingVelocity(), PublishingVelocityProps (+10 more)
...
Cohesion: 0.23
Nodes (10): usePosts(), FilterBar(), FilterBarProps, statusTabs, container, item, PostsContent(), PostsPage() (+2 more)
...
Cohesion: 0.19
Nodes (16): callWebhook(), cancelPost(), connectOAuth(), createPost(), updatePost(), call(), DashboardResult, getAccounts() (+8 more)
...
Cohesion: 0.12
Nodes (15): TallyDotProps, Button, ButtonProps, useMedia(), MediaGrid(), MediaGridProps, container, item (+7 more)
...
Cohesion: 0.18
Nodes (10): ConnectButton(), ConnectButtonProps, AccountsPage(), container, item, oauthErrors, useAccounts(), AccountsApp() (+2 more)

### Community 122 - "Community 122"
Cohesion: 0.24
Nodes (9): AuthGate(), useAuth(), useDashboard(), ComposerApp(), DashboardApp(), ConsoleShellProps, StatusBar(), TopBar() (+1 more)
...
## Knowledge Gaps
- **888 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+883 more)
...
- **Why does `useAuth()` connect `Community 122` to `Project Dependencies`, `Community 68`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 51`, `Community 20`, `Community 121`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 68` to `Project Dependencies`, `Community 37`, `Landing Page UI`, `Facebook Publish Workflow`, `Community 15`, `Community 20`, `Community 121`, `Community 63`?**
