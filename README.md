...
| Backend | **n8n** (11 workflows, webhook-driven) |
...
| 3 | Media Upload | Webhook | Register uploaded media |
| 4 | Post CRUD | Webhook | Create/edit/cancel scheduled posts |
| 5 | Cron Scheduler | Every 5 min | Poll pending posts, dispatch publish |
| 6 | Facebook Publish | Webhook | Create post via Graph API |
| 7 | Instagram Publish | Webhook | Create media container → publish |
| 8 | Token Refresh | Webhook | Refresh expiring Meta tokens |
| 9 | Retry Handler | Webhook | Exponential backoff (max 3 retries) |
| 10 | Failure Handler | Webhook | Log final failures |
| 11 | Logging | Webhook | Centralized audit log |
