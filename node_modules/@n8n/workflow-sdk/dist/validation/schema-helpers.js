...
Object.defineProperty(exports, "resolveOneOfSchemas", { enumerable: true, get: function () { return resolve_schema_1.resolveOneOfSchemas; } });
const resourceMapperFieldSchema = zod_1.z
    .object({
    id: zod_1.z.string().optional(),
    displayName: zod_1.z.string().optional(),
    required: zod_1.z.boolean().optional(),
    defaultMatch: zod_1.z.boolean().optional(),
    display: zod_1.z.boolean().optional(),
    type: zod_1.z.string().optional(),
    canBeUsedToMatch: zod_1.z.boolean().optional(),
})
    .passthrough();
const resourceMapperCommonSchema = zod_1.z
    .object({
    matchingColumns: zod_1.z.array(zod_1.z.string()).optional(),
...
const resourceMapperObjectSchema = resourceMapperCommonSchema.extend({
    ...
    value: zod_1.z.union([zod_1.z.null(), zod_1.z.record(zod_1.z.string(), zod_1.z.unknown())]).optional(),
    schema: zod_1.z.array(resourceMapperFieldSchema).optional(),
});
