...
exports.resolveOneOfSchemas = resolveOneOfSchemas;
...
function resolveOneOfSchemas({ parameters, variants, defaults = {}, isToolNode, }) {
    for (const variant of variants) {
        ...
        if ((0, display_options_1.matchesDisplayOptions)(context, variant.displayOptions)) {
    ...
    const message = requirementParts.length
        ...
        : 'This field is not applicable for the current configuration';
    return zod_1.z.any().refine((val) => val === undefined, { message });
}
