...
const sdkFunctions = {
    ...
    nodeJson: expression_1.nodeJson,
};
...
function parseWorkflowCodeToBuilder(code) {
    ...
    const executableCode = escapeN8nVariables(unescapedCode);
    try {
        const result = (0, ast_interpreter_1.interpretSDKCode)(executableCode, sdkFunctions);
...
function asWorkflowBuilder(result) {
    if ((0, typeguards_1.isWorkflowBuilder)(result)) {
        return result;
    }
    if ((0, typeguards_1.isWorkflowJSON)(result)) {
        return workflow_builder_1.workflow.fromJSON(result);
    }
