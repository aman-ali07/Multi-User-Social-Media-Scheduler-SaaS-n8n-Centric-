...
export declare function resolveErrorOutputIndex(type: string, parameters?: IDataObject): number;
export declare function foldLegacyErrorConnections(connections: IConnections, nodes?: readonly ErrorIndexNodeInfo[]): void;
export declare function normalizeConnections(connections: IConnections): void;
export declare function generateUniqueName(baseName: string, exists: (name: string) => boolean): string;
