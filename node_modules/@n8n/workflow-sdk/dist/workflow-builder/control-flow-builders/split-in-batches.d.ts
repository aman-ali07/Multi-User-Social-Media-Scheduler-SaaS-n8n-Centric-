import type { NodeInstance, SplitInBatchesBuilder, SplitInBatchesFactoryConfig, NodeChain, IfElseBuilder, SwitchCaseBuilder } from '../../types/base';
export type NodeBatch = NodeInstance<string, string, unknown> | Array<NodeInstance<string, string, unknown>>;
export type BranchTarget = null | NodeInstance<string, string, unknown> | NodeChain<NodeInstance<string, string, unknown>, NodeInstance<string, string, unknown>> | Array<NodeInstance<string, string, unknown> | NodeChain<NodeInstance<string, string, unknown>, NodeInstance<string, string, unknown>>> | IfElseBuilder<unknown> | SwitchCaseBuilder<unknown> | SplitInBatchesBuilder<unknown>;
