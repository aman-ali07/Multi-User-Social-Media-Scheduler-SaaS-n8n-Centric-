...
exports.containsPlaceholderMarker = containsPlaceholderMarker;
exports.extractHint = extractHint;
...
function containsPlaceholderMarker(value) {
    if (typeof value !== 'string')
        return false;
    return /<__PLACEHOLDER_VALUE__[\s\S]*?__>/.test(value);
}
function extractHint(value) {
