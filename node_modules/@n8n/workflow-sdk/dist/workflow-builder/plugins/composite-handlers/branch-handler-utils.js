...
function processBranchForComposite(branch, outputIndex, ctx, mainConns) {
    ...
    if (Array.isArray(branch)) {
        ...
        for (const branchNode of branch) {
            if (branchNode === null)
                continue;
            if ((0, node_builder_1.isInputTarget)(branchNode)) {
    ...
    else if ((0, node_builder_1.isInputTarget)(branch)) {
...
function processBranchForBuilder(branch, outputIndex, mainConns, targetNodeIds) {
    ...
    if (Array.isArray(branch)) {
        ...
        for (const t of branch) {
            ...
            if (targetName) {
                const targetIndex = (0, node_builder_1.isInputTarget)(t) ? t.inputIndex : 0;
        ...
        if (targetName) {
            const targetIndex = (0, node_builder_1.isInputTarget)(branch) ? branch.inputIndex : 0;
