        ...
        if (typeof config.credentials !== 'object') {
            ...
            for (const [key, value] of Object.entries(config.credentials)) {
                if (typeof value === 'string') {
                    if (value.startsWith('<__PLACEHOLDER_VALUE__') && value.endsWith('__>'))
                        continue;
            ...
            n8nNode.credentials = (0, n8n_workflow_1.deepCopy)(resolvable);
        }
    }
    if (config.disabled) {
...
exports.jsonSerializer = {
    ...
    serialize(ctx) {
        ...
        (0, base_1.foldLegacyErrorConnections)(connections, nodes);
        const json = {
            id: ctx.workflowId,
