import { type NodeInstance, type TriggerInstance, type NodeConfig, type NodeInput, type TriggerInput, type StickyNoteConfig, type NewCredentialValue, type InputTarget, type OutputSelector, type IfElseBuilder, type SwitchCaseBuilder } from '../../types/base';
...
export declare function normalizeNodeConfig(config: NodeConfig): NodeConfig;
...
export declare function placeholder(hint: string): string;
export declare function newCredential(name: string, id?: string): NewCredentialValue;
