...
exports.WORKFLOW_PATTERNS_DETAILED = void 0;
const SDK_IMPORT = "import { workflow, node, trigger, sticky, placeholder, newCredential, ifElse, switchCase, merge, splitInBatches, nextBatch, languageModel, memory, tool, outputParser, embedding, embeddings, vectorStore, retriever, documentLoader, textSplitter, reranker, fromAi, expr } from '@n8n/workflow-sdk';";
exports.WORKFLOW_PATTERNS_DETAILED = `<linear_chain>
\`\`\`javascript
${SDK_IMPORT}
...
//# sourceMappingURL=workflow-patterns-detailed.js.map