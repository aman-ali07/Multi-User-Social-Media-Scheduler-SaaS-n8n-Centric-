...
export type IExecuteFunctions = ExecuteFunctions.GetNodeParameterFn & BaseExecutionFunctions & {
    ...
    executeAgent(agentInfo: ExecuteAgentInfo, message: string, executionId: string, itemIndex: number): Promise<ExecuteAgentData>;
    ...
    helpers: RequestHelperFunctions & BaseHelperFunctions & BinaryHelperFunctions & DeduplicationHelperFunctions & FileSystemHelperFunctions & SSHTunnelFunctions & DataTableProxyFunctions & CredentialCheckProxyFunctions & {
...
export interface IPollFunctions extends FunctionsBaseWithRequiredKeys<'getMode' | 'getActivationMode'> {
    __emit(data: INodeExecutionData[][], responsePromise?: IDeferredPromise<IExecuteResponsePromiseData>, donePromise?: IDeferredPromise<IRun | undefined>): void;
...
export interface ITriggerFunctions extends FunctionsBaseWithRequiredKeys<'getMode' | 'getActivationMode'> {
    emit(data: INodeExecutionData[][], responsePromise?: IDeferredPromise<IExecuteResponsePromiseData>, donePromise?: IDeferredPromise<IRun>, deduplicationKey?: string): void;
    /**
...
export interface INodeExecutionData {
    [key: string]: IDataObject | IBinaryKeyData | INodeExecutionRedactionInfo | IPairedItemData | IPairedItemData[] | NodeApiError | NodeOperationError | number | string | undefined;
    json: IDataObject;
...
export type ThemeIconColor = 'neutral' | 'gray' | 'black' | 'blue' | 'light-blue' | 'dark-blue' | 'sky-blue' | 'orange' | 'orange-red' | 'amber' | 'rust' | 'pink-red' | 'magenta' | 'red' | 'light-green' | 'green' | 'dark-green' | 'emerald' | 'forest-green' | 'lime' | 'azure' | 'teal' | 'purple' | 'violet' | 'lavender' | 'crimson';
...
export interface IWorkflowExecuteAdditionalData {
    ...
    executeAgent?: (agentId: string, message: string, executionId: string, threadId: string, additionalData: IWorkflowExecuteAdditionalData) => Promise<ExecuteAgentData>;
...
export declare namespace WorkflowSettings {
    ...
    type RedactionPolicy = 'none' | 'all' | 'non-manual' | 'manual-only';
}
...
export interface INodeGraphItem {
    ...
    ai_gateway_credentials?: boolean;
}
