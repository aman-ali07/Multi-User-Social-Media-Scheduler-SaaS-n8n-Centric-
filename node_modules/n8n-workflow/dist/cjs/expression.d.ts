import type { ObservabilityProvider } from '@n8n/expression-runtime';
...
export declare class Expression {
     ...
     */
    static initExpressionEngine(options: {
        engine: 'legacy' | 'vm';
