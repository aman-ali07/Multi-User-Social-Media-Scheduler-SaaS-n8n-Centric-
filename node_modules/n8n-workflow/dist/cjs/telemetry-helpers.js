(function (factory) {
    ...
    function extractNodeTokenUsage(nodeRunData) {
        ...
        for (const task of nodeRunData) {
            const lmOutputs = task.data?.[interfaces_1.NodeConnectionTypes.AiLanguageModel];
            if (lmOutputs) {
    ...
    function generateNodesGraph(workflow, nodeTypes, options) {
        ...
        otherNodes.forEach((node, index) => {
            ...
            if (node.type.startsWith(constants_1.LANGCHAIN_LM_NODE_TYPE_PREFIX)) {
            ...
            if (constants_1.AI_VENDOR_NODE_TYPES.includes(node.type)) {
